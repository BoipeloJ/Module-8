...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(id='dropdown-statistics', 
                  ...
                  style={"width": '80%', "text-align": "center", "font-size": 20})
    ]),
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        emp_rate = recession_data.groupby('Vehicle_Type')['Unemployment_Rate']
        R_chart4 = px.bar(data=emp_rate,x='unemployment_rate',y='Automobile_Sales')
        R_chart4.show()
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(tma, 
                 x='Month',
                 y='Automobile_Sales',
                 title="Total Number Of Vehicles Sold By Vehicle Type"))
